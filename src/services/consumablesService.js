...
export const consumablesService = {
    ...
    addIncome: (consumableId, zoneId, amount) => 
        api.post('/consumables/income', { consumablesId: consumableId, zoneId: zoneId, count: amount }),
    addExpense: (consumableId, zoneId, amount) => 
        api.post('/consumables/expense', { consumablesId: consumableId, zoneId: zoneId, count: amount }),
